...
public class MouseMoveCtrl implements MouseMotionListener, MouseListener {
	...
	public void mouseMoved(MouseEvent me) {
		...
		if (container.isVisible()) {
			// there were issues with adding a piece to the board and then
			// clicking any of the rotate/flip buttons
			if (l instanceof LevelPanel)
	...
	public void mousePressed(MouseEvent arg0) {
		if (container.isVisible()) {
			// if source is board it cannot be dropped anywhere else but the
			// board
	...
	public void mouseReleased(MouseEvent arg0) {
		// there were issues with adding a piece to the board and then clicking
		// any of the rotate/flip buttons
		if (l instanceof LevelPanel) {
